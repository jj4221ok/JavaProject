	...
	public static void main(String[] args) {
				...
				while(run) {
					...
					case 1 :
						...
						//client.setBalance(balance); 대신
						// 매개변수(파라미터)를 이용해서 한꺼번에 처리
					...
					case 4 : 
						...
						// balance는 int타입이라 이렇게 하면 서버에 int로 넘어간다
						// server.checkBalance(accountNumber); 만 쓰면 void로 넘어감
